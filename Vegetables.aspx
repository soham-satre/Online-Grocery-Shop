<%@ Page Title="" Language="C#" MasterPageFile="~/Online Grocery Shop/GrocerySite.master" AutoEventWireup="true" CodeFile="Vegetables.aspx.cs" Inherits="Vegetables" EnableEventValidation="false" %>
                    ...
                    <table>
                        <tr>
                            <td style="border-style: dashed; border-width: 1px;">
                                <asp:Image ID="imgPd" CssClass="imgclass" runat="server" ImageUrl='<%#"~/Online Grocery Shop/Images/"+Eval("ImageUrl").ToString() %>' /><br />
                                <br />
                                Product Name:
