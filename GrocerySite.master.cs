...
public partial class PerfumeMaster : System.Web.UI.MasterPage
{
    ...
    protected void logout_Click(object sender, EventArgs e)
    {
        if (Session["User"] != null)
        {
            ...
            Session.RemoveAll();
            Session.Clear();
            Response.Redirect("~/Online Grocery Shop/Home.aspx");
        }
        else
        {
            Response.Redirect("~/Online Grocery Shop/Home.aspx");
    ...
    protected void signin_Click(object sender, EventArgs e)
    {
        ...
        if (dr.HasRows)
        {
            ...
            Response.Redirect("~/Online Grocery Shop/Products.aspx");
        }
        cn.Close();
        upllogin.Update();
    }
    ...
    {
        Response.Redirect("~/Online Grocery Shop/Search.aspx?Q=" + txtsearch.Text.Trim() + "");
    }
    protected void lbtoredrhistory_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Online Grocery Shop/OrderHistory.aspx");
    }
}
