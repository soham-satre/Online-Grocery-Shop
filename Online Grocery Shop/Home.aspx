<%@ Page Title="" Language="C#" MasterPageFile="~/Online Grocery Shop/GrocerySite.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <div style="float: left; width: 300px;">
            <div class="sideLogin">
                <div class="welcome">Welcome To Fresho Veggie Mart</div>
                <p>
                    At Fresho Veggie Mart our goal is to provide you with the wide varieties of Fruits and Vegetables.
                </p>
                <table>
                    <tr>
                        <td>UserName
                    ...
                    <tr>
                        <td></td>
                        <td colspan="2">
                            <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="button" OnClick="btnLogin_Click" />&nbsp;&nbsp;<br /><br />
                            <asp:LinkButton ID="lnkRegister" runat="server" Text="New Registration" PostBackUrl="~/Online Grocery Shop/Registration.aspx" CausesValidation="False" CssClass="button" ForeColor="White"/>&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="adminbtn" runat="server" Text="Admin" PostBackUrl="~/Online Grocery Shop/Admin/Admin.aspx" CausesValidation="False" CssClass="button" ForeColor="White"/>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <div class="contact_informatin">
                    ...
                    <table class="call">
                        ...
                        <tr>
                            ...
                            <td>helpsupport111@gmail.com</td>
                        </tr>
                    </table>
